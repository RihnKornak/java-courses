...
<div class="layout">
    ...
    <div class="content">
        <div align="center" width="100"> <form action="${pageContext.servletContext.contextPath}/showclients" method="post">
            <p>Поиск клиента</p>
            <input type="search" maxlength="25" size="40" name="search">
            <p><input type="submit" value="Найти"></p>
        </form>
        </div>
       <p>Тут будут отображаться клиенты</p>
        <table border="1">
            <tr>
                <td>Имя клиента</td>
